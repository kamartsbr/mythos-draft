...
export function GodPicker({ lobby, isCaptain1, isCaptain2, handlePickerAction, timeLeft, t }: GodPickerProps) {
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          {isRevealing ? (
              ...
              <div className="relative z-10 flex items-center gap-6 md:gap-12">
                ...
                >
                  ...
                  <div className="w-24 h-24 md:w-32 md:h-32 rounded-3xl overflow-hidden border-4 border-blue-500 shadow-[0_0_30px_rgba(59,130,246,0.3)]">
                    <img 
                      src={MAJOR_GODS.find(g => g.id === lobby.pickerVoteA)?.image} 
                      alt="God A" 
                  ...
                  <h3 className="text-sm font-black text-white uppercase tracking-tight">
                    {MAJOR_GODS.find(g => g.id === lobby.pickerVoteA)?.name}
                  </h3>
                </motion.div>
                ...
                >
                  ...
                  <div className="w-24 h-24 md:w-32 md:h-32 rounded-3xl overflow-hidden border-4 border-red-500 shadow-[0_0_30px_rgba(239,68,68,0.3)]">
                    <img 
                      src={MAJOR_GODS.find(g => g.id === lobby.pickerVoteB)?.image} 
                      alt="God B" 
                      className="w-full h-full object-cover" 
                      referrerPolicy="no-referrer" 
                    />
                  ...
                  <h3 className="text-sm font-black text-white uppercase tracking-tight">
                    {MAJOR_GODS.find(g => g.id === lobby.pickerVoteB)?.name}
                  </h3>
                </motion.div>
              </div>
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto pr-1 custom-scrollbar">
                  <div className="grid grid-cols-5 sm:grid-cols-8 lg:grid-cols-10 xl:grid-cols-12 gap-1.5 pb-2">
                    {myGodPool.map(godId => {
                      ...
                      const isSelected = myVote === godId;
                      const isDisabled = isUsed || !!myVote || (!isCaptain1 && !isCaptain2);
              ...
              {lobby.config.preset === 'MCL' && myVote && !selectedPlayerId && (
                      ...
                      {myVote ? (
                        <>
                          <div className="w-10 h-10 rounded-xl overflow-hidden border-2 border-amber-500 shadow-[0_0_15px_rgba(245,158,11,0.2)]">
                            <img 
                              src={MAJOR_GODS.find(g => g.id === myVote)?.image} 
                              alt="Selected" 
                              className="w-full h-full object-cover"
                              referrerPolicy="no-referrer"
                            />
                          ...
                          <div>
                            <h4 className="text-xs font-black text-white uppercase tracking-tight">
                              {MAJOR_GODS.find(g => g.id === myVote)?.name}
                            </h4>
