...
export function PlayerSlot({ pick, isCurrentTurn, t, isHidden, preset, index }: PlayerSlotProps) {
  ...
  const displayName = isHidden 
    ...
    : (pick.playerName || (preset === 'MCL' ? `${t.selecting || 'Selecting'}...` : `Player ${pick.playerId}`));
    ...
    >
      ...
      <div className="relative z-10 h-full flex items-center px-4 gap-4">
        ...
        <div 
          ...
          style={{ backgroundColor: showColor ? pick.color : '#1e293b' }}
        />
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className={cn(
            ...
            god ? "text-amber-500" : "text-slate-600"
          )}>
