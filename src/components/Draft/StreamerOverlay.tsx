...
export function StreamerOverlay({ lobbyId }: StreamerOverlayProps) {
  ...
  const isObsMode = searchParams.get('view') === 'obs';
              ...
              <div className="flex flex-col gap-6 flex-1">
                {displayPicksA.map((pick, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div 
                        className="w-24 h-24 rounded-2xl overflow-hidden border-2 bg-slate-900 shadow-2xl transition-all relative"
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-3xl font-black uppercase text-white tracking-tight drop-shadow-xl">
