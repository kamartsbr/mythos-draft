...
export const discordService = {
  ...
  generateEmbed(lobby: Lobby) {
    ...
    return {
      ...
      fields: [
        { name: 'Capitão A', value: sanitizeForDiscord((lobby.teamAName || lobby.captain1Name) || lobby.captain1 || 'Vago'), inline: true },
        { name: 'Capitão B', value: sanitizeForDiscord((lobby.teamBName || lobby.captain2Name) || lobby.captain2 || 'Vago'), inline: true }
      ],
