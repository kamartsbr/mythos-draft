                  ...
                  <div className="relative">
                    ...
                    <motion.div 
                      ...
                      className={cn(
                        ...
                        isSelected ? "border-white bg-amber-500 shadow-[0_0_20px_rgba(251,191,36,0.8)]" : "opacity-50"
                      )}
                      style={{ 
                ...
                <AnimatePresence mode="wait">
                  {showGod && (
                    <motion.div
                      ...
                      className={cn(
                        "w-14 h-14 rounded-full border-2 bg-slate-900 overflow-hidden shadow-xl z-10 relative",
                        isSelected && "ring-4 ring-amber-500 ring-offset-2 ring-offset-slate-950"
                      )}
                      style={{ borderColor: playerColor, boxShadow: `0 0 20px ${playerColor}60` }}
                    >
                      <img 
                        src={god?.image} 
                        alt={god?.name}
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        {timeLeft !== null && timeLeft !== undefined && (
          <motion.div 
            ...
            className={cn(
              "px-6 py-2 rounded-xl border-2 flex items-center gap-3 transition-all duration-300 bg-slate-900/40 backdrop-blur-md shadow-lg",
              timeLeft <= 5 ? "border-red-500 shadow-[0_0_20px_rgba(239,68,68,0.3)]" : "border-slate-800"
            )}
          >
            <Clock className={cn("w-4 h-4", timeLeft <= 5 ? "text-red-500 animate-pulse" : "text-amber-500")} />
            <span className={cn("text-2xl font-black tabular-nums tracking-tight", timeLeft <= 5 ? "text-red-500" : "text-white")}>
              {timeLeft}
            </span>
          </motion.div>
        )}
