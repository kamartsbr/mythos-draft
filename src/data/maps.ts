...
export const MAPS: MapInfo[] = [
  ...
  { id: 'obsidian_ridge', name: 'Obsidian Ridge', image: '/Obsidian_Ridge_Minimap_94-876-396x396.webp', isRanked: true, positions: DEFAULT_POSITIONS },
  { id: 'cloud_forest', name: 'Cloud Forest', image: '/Cloud_Forest_minimap_092-4-396x396.webp', isRanked: true, positions: DEFAULT_POSITIONS },
